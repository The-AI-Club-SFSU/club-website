                        ...
                        {leadership.map(
                            (section, index) => (
                                <div className={currentPage == index ? 'block' : 'hidden'} key={section.toString()}>
                                    ...
                                    <div className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 justify-items-center align-middle gap-x-4 sm:gap-x-7 gap-y-[18px] group/majorcards max-w-[900px] mx-auto'>
                                        {section.major.map(
                                            (details, index) => (
                                                <MajorLeaderCard
