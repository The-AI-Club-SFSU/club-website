...
export function Navbar(): React.ReactNode {
    ...
    return (
        <nav className='z-50 absolute flex flex-col w-full'>
            ...
            >
                <Link href='/' className='z-10 absolute left-0 flex items-center justify-center gap-x-2 drop-shadow-lg ml-4 hover:rotate-180 active:animate-pulse duration-500'>
                    <Image
                        width={48}
                        height={48}
