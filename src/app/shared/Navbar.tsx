        ...
        <nav className='z-50 absolute flex flex-col w-full'>
            ...
            >
                ...
                <div className='hidden md:flex flex-row text-[15px] font-semibold w-full justify-center gap-x-2 opacity-35 hover:opacity-100 transition-opacity duration-300'>
                    ...
                    <Link href='https://discord.gg/tDtqmP5sGt' target='_blank' className='py-1 px-3 hover:px-6 active:scale-90 flex bg-neutral-950/25 hover:bg-pink-400/30 rounded-lg transition-all duration-300'>
